// ════════════════════════════════════════════════════════════
// 天鷹保全 · 開店前管理 SQL遷移【第三階段：getTodayRows 讀取層】
// ────────────────────────────────────────────────────────────
// 用途：getTodayRows 給「今日」分頁用，開店前工具撈「今天整天」
//       （今天00:00~明天00:00，日曆日不分早晚班），改讀Supabase用
...
//
// 需要跟遷移腳本（開店_SQL遷移腳本.gs）貼在同一個專案，共用
...
function getTodayRows_SQL() {
  ...
  var path = '/rest/v1/opening_gate_logs'
